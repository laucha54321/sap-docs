---
title: Modificar mails en CC de Facturación Automática
sidebar_position: 2
---

## Descripción
Modificar, agregar o quitar emails del programa de envió automático de mails de facturación. Este email sale del mensaje automático ZZFA para los documentos SD y de un job automático diario para los documentos FI.

## Pasos
### 1. Ingresar en la TX `STVARV` y buscar la variable `ZSD_FC_MAIL_ADIC`.\
...
En la nueva pantalla hay que chequear en la variable este el nombre correcto `ZSD_FC_MAIL_ADIC`. Y ahi seleccionamos en Type la opción que dice "Select Option". Y le hacemos click al botón de lápiz. 
