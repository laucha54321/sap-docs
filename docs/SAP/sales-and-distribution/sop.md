...
1. **Rechazar la línea del material que queremos cambiar por otro**. 
![image_20260128170439](/img/Pasted image 20260128170439.png) 
2. Crear una nueva línea con el material y la cantidad apropiada. ![image_20260128170646](/img/Pasted image 20260128170646.png) 
...
En el caso que queramos anular una línea por que existe un error, **es importante que no la eliminemos**. En esos casos rechazamos la línea y la dejamos en la orden. ![image_20260128171121](/img/Pasted image 20260128171121.png) 
