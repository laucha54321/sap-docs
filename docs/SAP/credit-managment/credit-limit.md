...
:::note
En el caso de necesitar hacer un update masivo a la información crediticia se puede utilizar la transacción [ZMASS_UKM](/SAP/tx&programas/transactions/zmass_ukm).
:::